...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Loadfile = __webpack_require__(235);

	var _Loadfile2 = _interopRequireDefault(_Loadfile);

	var _Seeresult = __webpack_require__(238);

	var _Seeresult2 = _interopRequireDefault(_Seeresult);

	var _langAPI = __webpack_require__(233);

	var _langAPI2 = _interopRequireDefault(_langAPI);
	...
	function init() {
	    ...
	    fetch('./js/lang.json').then(function (response) {
	        return response.json().then(function (responseData) {
	            _langAPI2.default.setLangData(responseData);
	            _reactDom2.default.render(_react2.default.createElement(RootsMainComp, { lang: "ru", __self: _this
	            }), app);
	        });
	    });
	}
	...
	var ContactsAppContainer = function (_React$Component) {
	    _inherits(ContactsAppContainer, _React$Component);

	    function ContactsAppContainer() {
	        _classCallCheck(this, ContactsAppContainer);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(ContactsAppContainer).call(this));
	    ...
	    _createClass(ContactsAppContainer, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            fetch('./js/lang.json').then(function (response) {
	                return response.json().then(function (responseData) {
	                    _langAPI2.default.setLangData(responseData);
	                    _reactDom2.default.render(_react2.default.createElement(RootsMainComp, {
	                        __self: _this3
	                    }), app);
	                });
	            });
	...
	var RootsMainComp = function (_React$Component2) {
	    _inherits(RootsMainComp, _React$Component2);

	    function RootsMainComp() {
	        _classCallCheck(this, RootsMainComp);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RootsMainComp).apply(this, arguments));
	    }

	    _createClass(RootsMainComp, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                _reactRouter.Router,
	                { history: _reactRouter.hashHistory, lang: this.props.lang, __self: this
	                },
	                _react2.default.createElement(
	                    _reactRouter.Route,
	                    { path: "/", component: _Nav2.default, __self: this
	                    },
	                    _react2.default.createElement(_reactRouter.IndexRoute, { component: _Table2.default, __self: this
	                    }),
	                    _react2.default.createElement(_reactRouter.Route, { path: "loadfile", name: "loadfile", component: _Loadfile2.default, __self: this
	                    }),
	                    _react2.default.createElement(_reactRouter.Route, { path: "seeresult", name: "seeresult", component: _Seeresult2.default, __self: this
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useQueries = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(232);
	...
	var NavbarHeader = function (_React$Component) {
	  ...
	  function NavbarHeader() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NavbarHeader).apply(this, arguments));
	  }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('span', { className: 'icon-bar', __self: this
	          }),
	          _react2.default.createElement('span', { className: 'icon-bar', __self: this
	          }),
	          _react2.default.createElement('span', { className: 'icon-bar', __self: this
	        ...
	        _react2.default.createElement(
	          'a',
	          { className: 'navbar-brand', href: '#', __self: this
	          },
	          'Pepsi'
	        )
	      );
	...
	var NavbarItems = function (_React$Component2) {
	  _inherits(NavbarItems, _React$Component2);

	  function NavbarItems() {
	    _classCallCheck(this, NavbarItems);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _langAPI2.default.getLang(this.props.lang, 'main')
	            )
	          ),
	          _react2.default.createElement(
	            'li',
	            ...
	            _react2.default.createElement(
	              ...
	              _langAPI2.default.getLang(this.props.lang, 'action'),
	              ' ',
	            ...
	            _react2.default.createElement(
	              'ul',
	              { className: 'dropdown-menu', role: 'menu', __self: this
	              },
	              _react2.default.createElement(
	                'li',
	                ...
	                _react2.default.createElement(
	                  ...
	                  (0, _marked2.default)(_langAPI2.default.getLang(this.props.lang, 'loadfile')),
	                  ' '
	                )
	              ),
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _langAPI2.default.getLang(this.props.lang, 'checkresult')
	                )
	              )
	            )
	          )
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('a', { href: '#', __self: this
	            })
	          )
	        )
	      );
	  ...
	  _createClass(Nav, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'nav',
	          { className: 'navbar navbar-default', __self: this
	          },
	          _react2.default.createElement(
	            'div',
...
/***/ function(module, exports) {
	...
	exports.default = function langAPI() {

	    var lang;
	    var setLangData = function setLangData(langData) {
	        if (!lang) {
	            lang = langData;
	        }
	        console.log(lang);
	    ...
	    var getLang = function getLang(lang_name, field) {
	        return lang[lang_name][field];
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tables = function (_React$Component) {
	  ...
	  function Tables() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Tables).apply(this, arguments));
	  }
	  ...
	  _createClass(Tables, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "table",
	          { className: "table table-striped table-hover ", __self: this
	          },
	          _react2.default.createElement(
	            "thead",
	            {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loadfile = function (_React$Component) {
	    ...
	    function Loadfile() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Loadfile).call(this));
	    ...
	    _createClass(Loadfile, [{
	        key: '_handleFileDrop',
	        value: function _handleFileDrop(files) {
	            var _this2 = this;

	            this.setState({
	                files: files
	            }, function () {
	                (0, _FileUploadAjax2.default)({ files: _this2.state.files, url: 'dump', filesFieldName: 'name', method: 'POST' });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { onDrop: this._handleFileDrop.bind(this), __self: this
	                    },
	                    _react2.default.createElement(
	                        'div',
	                        {
